<?php
/**
 * API: qianmi.elife.directRecharge.waterCoal.item.list request
 * 
 * @author auto create
 * @since 1.0
 */
class DirectRechargeWaterCoalItemListRequest
{
	...
	{
		return "qianmi.elife.directRecharge.waterCoal.item.list";
	}
