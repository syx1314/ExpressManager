<?php
/**
 * API: bm.elife.directRecharge.waterCoal.item.list request
 * 
 * @author auto create
 * @since 1.0
 */
class BmDirectRechargeWaterCoalItemListRequest
{
	...
	{
		return "bm.elife.directRecharge.waterCoal.item.list";
	}
