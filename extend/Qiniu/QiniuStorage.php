...
class QiniuStorage
{
    ...
    public $QINIU_UP_HOST = 'http://up.qiniup.com';
    public $timeout = '';
    ...
    public function __construct($config)
    {
        ...
        $this->QINIU_UP_HOST = isset($config['host']) ? 'http://' . $config['host'] : $this->QINIU_UP_HOST;
    ...
    public function getToken()
    {
        ...
        return $this->UploadToken($this->sk, $this->ak, $config);
    }
