<?php
/**
 * API: bm.elife.directRecharge.waterCoal.getAccountInfo request
 * 
 * @author auto create
 * @since 1.0
 */
class BmDirectRechargeWaterCoalGetAccountInfoRequest
{
	...
	{
		return "bm.elife.directRecharge.waterCoal.getAccountInfo";
	}
