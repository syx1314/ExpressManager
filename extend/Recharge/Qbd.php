...
//            }
            ...
            $data = $res['data'];
            $data=$this->calPrice2($data['type'],$data);
    ...
    public function calPrice2($type,$data) {

        $data =  [
            'priceA'=>$data['priceA'],
            'priceB'=>$data['priceB'],
            'discount'=>$data['discount'],
            'fee1'=>$data['channelFee'], // 渠道价格
            'fee'=>$data['originalFee'], // 渠道原价
            'totalFeeOri'=>$data['originalFee'],
            'totalFee'=>$data['channelFee'],
