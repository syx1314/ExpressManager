...
class Error
{
    ...
    public static function appError($errno, $errstr, $errfile = '', $errline = 0)
    {
        ...
        if (IS_CLI) {
            $content = '<h2>错误：' . $errstr . '</h2>';
            $content .= '<p style="font-size:10px;background-color:#000;color:#fff;">' . $errfile . ' ' . $errline . '行</p>';
            $content .= '<p><br/>详细错误：' . $exception->getTraceAsString() . '<br/></p>';
            $title = "CLI系统报错猿人V2【" . __DIR__ . "】" . "【" . date("Y-m-d H:i:s") . "】";
